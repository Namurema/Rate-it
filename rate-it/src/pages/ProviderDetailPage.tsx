  ...
  if (providerLoading) {
    return (
      <div className="min-h-screen bg-gray-50">
        <nav className="flex items-center px-6 md:px-12 py-4 bg-white border-b border-gray-200">
          <span className="text-2xl font-bold tracking-tight">Rate<span className="text-orange-500">.it</span></span>
        </nav>
  ...
  if (notFound || !provider) {
    return (
      <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center text-center px-6">
        ...
        <button onClick={() => navigate('/')} className="text-sm font-medium text-orange-500 hover:text-orange-600 transition-colors">
          ← Back to home
        </button>
      </div>
    )
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10 space-y-8">
        ...
        <section>
          <div className="flex items-center gap-2 mb-5">
            ...
            <h2 className="text-lg font-semibold text-gray-800">
              Reviews {reviewCount > 0 && <span className="text-gray-400 font-normal text-base">({reviewCount})</span>}
            </h2>
          </div>
        ...
        {/* SUBMIT REVIEW FORM */}
        <section>
          <h2 className="text-lg font-semibold text-gray-800 mb-5">Write a Review</h2>
